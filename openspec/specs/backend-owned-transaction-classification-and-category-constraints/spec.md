# backend-owned-transaction-classification-and-category-constraints Specification

## Purpose
Document backend ownership for transaction classification, category eligibility, transaction reference validation, and category/subcategory integrity constraints.
