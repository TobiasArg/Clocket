...
export {
  ...
  httpBudgetsRepository as budgetsRepository,
  httpCategoriesRepository as categoriesRepository,
  httpCuotasRepository as cuotasRepository,
  httpGoalsRepository as goalsRepository,
  httpInvestmentsRepository as investmentsRepository,
